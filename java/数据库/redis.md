>[!definition]
>Redis is a NoSQL database which follows the principle of key-value store.Redis supports various types of data structures like strings, hashes, lists, sets, sorted sets, bitmaps, hyperloglogs and geospatial indexes with radius queries.
# architecture
- Redis Client
- Redis Server
![[Pasted image 20231118214709.png]]
# Data Type
## Strings
```redis
